...
class ConvNeXt(nn.Module):
    ...
    def __init__(
            ...
            head_init_scale=1., head_norm_first=False, norm_layer=None, drop_rate=0., drop_path_rate=0., probing_mode='mp', tuning_mode=None
    ):
        super().__init__()
...
if __name__ =='__main__':
    ...
    model = convnext_base_in22k(probing_mode='mp', tuning_mode='psrp',)  
    y = model(x)
    print(y.shape)  